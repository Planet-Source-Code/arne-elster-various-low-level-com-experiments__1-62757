...
Private Declare Function CallWndProc Lib "user32" Alias "CallWindowProcA" ( _
    ByVal adr As Long, ByVal p1 As Long, _
    ByVal p2 As Long, ByVal p3 As Long, _
...
Private Declare Function lcid Lib "kernel32" Alias "GetSystemDefaultLCID" ( _
    ) As Long
...
Public Function GetObjMembers(obj As Object) As enmeinf()
    ...
    ret = CallPointer(pGetTpInf, ObjPtr(obj), 0, lcid, VarPtr(pptInfo))
